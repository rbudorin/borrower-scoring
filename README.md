...
Согласно требованиям все аргументы передаваемые функции на вход могут обладать как минимум одним признаком, характеризующим степень влияния на алгоритм принятия решения о выдаче займа:

* Отказ при определенном значении
* Отказ в сочетании со значением другого аргумента
* Отказ в результате предварительных рассчетов платежа
* Величина годового платежа

Зависимость можно представить в виде таблицы с условными обозначениями:

| Аргумент      | Пользователь  | PSID  |  
| ------------- |---------------| ------|
| Возраст |  |  |
| Пол |  |  |
| Источник дохода |  |  |
