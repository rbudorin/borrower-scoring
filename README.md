...
| ID | Описание |  
|------------------|---------------|
| 5.1 | Ставка в зависимости от суммы кредита |
| 5.2 | Ставка в зависимости от кредитного рейтинга, цели и дохода |
| 5.3 | Ставка в зависимости от цели |
| 5.4 | Получение в возрасте от 0 до пенсионного |
| 5.5 | Получение минимально возможной суммы 0.1 |
| 5.6 | Получение кредита на срок от 1 до 10 лет |
| 5.7 | Получение суммы <= ограничению по источнику дохода |
| 5.8 | Получение суммы <= ограничению по кредитному рейтингу |
| 5.9 | Получение суммы <= минимальной из ограничения по кредитному рейтингу и источнику дохода |
| 5.10 | Получение суммы, годовой платеж по которой(без процентов) <= трети готового дохода |
