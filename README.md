...
Согласно требованиям все аргументы передаваемые функции на вход могут обладать как минимум одним признаком, характеризующими степень влияния на алгоритм принятия решения о выдаче займа:

* Отказ при определенном значении
* Отказ при определенном значении в сочетании со значением другого аргумента
